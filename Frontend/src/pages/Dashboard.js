...
export const data = {
  labels: ["Apple", "Samsung", "Oppo", "Vivo", "Oneplus", "Xiamoi"],
  datasets: [
    {
      label: "# of Votes",
      data: [10, 25, 15, 18, 19, 20],
      backgroundColor: [
        "rgba(255, 99, 132, 0.2)",
        "rgba(54, 162, 235, 0.2)",
        "rgba(255, 206, 86, 0.2)",
...
function Dashboard() {
  ...
  const [chart, setChart] = useState({
    ...
    series: [
      {
        name: "series",
        data: [100, 120, 140, 250, 260, 120, 310, 235, 445, 270, 125, 270],
      },
    ],
  });
      ...
      <div className="grid grid-cols-1 col-span-12 lg:col-span-10 gap-6 md:grid-cols-3 lg:grid-cols-4  p-4 ">
        ...
        <article className="flex flex-col  gap-4 rounded-lg border border-gray-100 bg-white p-6 ">
          <div className="inline-flex gap-2 self-end rounded bg-red-100 p-1 text-red-600">
            ...
            <span className="text-xs font-medium"> 10.1% </span>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              <span className="text-xs text-gray-500"> from ₹500000 </span>
            </p>
          </div>
        </article>
        <article className="flex flex-col   gap-4 rounded-lg border border-gray-100 bg-white p-6 ">
